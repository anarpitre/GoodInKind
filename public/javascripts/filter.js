...
tagJS.prototype.render = function(parentNode){
  var parentObj = this;
...
tagJS.prototype.link = function(url, attrs, content){
  attrs = attrs || {};
  attrs['href'] = url;
  return this.content_tag('a', attrs, content)
};

tagJS.prototype.image = function(url, attrs){
  attrs = attrs || {};
  attrs['src'] = url;
  return this.content_tag('img', attrs)
};
tagJS.prototype.div = function(attrs, content){
  return this.content_tag('div', attrs, content);
};
tagJS.prototype.span = function(attrs, content){
  return this.content_tag('span', attrs, content);
};

tagJS.prototype.li = function(attrs, content){
  return this.content_tag('li', attrs, content);
};
tagJS.prototype.ul = function(attrs, content){
  return this.content_tag('ul', attrs, content);
};


tagJS.prototype.filter_event = function(settings){
...
tagJS.prototype.grep = function(filter_out, value) {
...
tagJS.prototype.get_view_object = function(filter_name, categories, filter_type){
    var out = [];
    var parentObj = this;
...
tagJS.prototype.parse_map = function(field_map, root){
...
tagJS.prototype.map_objects = function(settings){
    var parentObj = this;
...
tagJS.prototype.category_map = function(data, settings){
...
tagJS.prototype.hideShow = function(id_arr){
