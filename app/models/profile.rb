class Profile < ActiveRecord::Base
  ...
  validates_attachment_content_type :avatar, :content_type => ["image/jpeg", "image/png", "image/gif", "image/jpg", "image/bmp", "image/tiff", "image/tif","image/pjpeg", "image/x-png" ], :message=> "Invalid image, image format should be jpeg/ jpg/ png/ gif"
